...
public class QuestionsBegin {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Row> canStream = env.fromSource(source, WatermarkStrategy.noWatermarks()
                ,"canSource")
                .filter(row -> true);
...
//        canStream.print();
        ...
        canStream
                .keyBy(value -> {
                    ...
                    return value.getFieldAs("trip_id");
                })
                .flatMap(new MovingState("trip_id", "gy", "source_timestamp"))
                .print();

//        /* Question 3 */
//        canStream
//                .keyBy(value -> value.getFieldAs("trip_id"))
//                .map(new MovingState("trip_id", "gx", "source_timestamp"))
//                .print();
//
//        /* Question 4 */
//        canStream
//                .keyBy(value -> value.getFieldAs("trip_id"))
//                .map(new MovingState("trip_id", "dashboard_speed", "source_timestamp"))
//                .print();
//
//        /* Question 6 */
//        canStream
//                .keyBy(value -> value.getFieldAs("trip_id"))
//                .map(new MovingState("trip_id", "ecozone", "source_timestamp"))
//                .print();
//
//        /* Question 7 */
//        canStream
//                .keyBy(value -> value.getFieldAs("trip_id"))
//                .map(new MovingState("trip_id", "steering_angle", "source_timestamp"))
//                .print();
